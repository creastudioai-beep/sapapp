...
def generate_all_pages(data: dict, output_dir: str):
    ...
    # ------------------------------------------------------------------
    # 5. (Archive pages removed — no longer generated)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 14. (Telegram archive data removed — no longer deployed)
    # ------------------------------------------------------------------
...
def generate_sitemaps(data: dict, output_dir: str):
    ...
    _write_file(
        ...
        generate_sitemap_index(post_sitemap_count, product_sitemap_count),
    )

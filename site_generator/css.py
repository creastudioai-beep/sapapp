...
#matrix-bg { position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 0; pointer-events: none; opacity: 0.2; }
...
# =============================================================================
# Archive CSS — for archive grid layout (matching Worker's archive page)
# =============================================================================
...
@media (max-width: 480px) {
    ...
    .archive-card-image, .archive-video-card, .archive-card-noimg {
        height: 160px;
    }
}
"""
